        ...
        <div class="center_title_bar">' . $podatak->get('naziv') . '</div>
          <div class="prod_box_big">
            ...
            <div class="center_prod_box_big">
              <div class="product_img_big"> <a href="javascript:popImage("' . base_url('assets/images/big_pic.jpg') . '","Some Title")" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="'. (base_url('assets/images/' . $podatak->get('slika'))). '" alt="" border="0" /></a>
